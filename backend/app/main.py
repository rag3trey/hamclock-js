...
from .routers import astronomy, satellites, spaceweather, dxcluster, config, maps, band_conditions, ncdxf, psk_reporter, maidenhead, qrz, activations, gps, cat, gimbal, contests, rss
